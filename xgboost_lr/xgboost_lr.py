...
def xgb_feature_encode(libsvmFileNameInitial, xgb_feature_libsvm):

    # load样本数据
    X_all, y_all = load_svmlight_file(libsvmFileNameInitial)
    dtrain = xgb.DMatrix(libsvmFileNameInitial)
...
if __name__ == '__main__':
    ...
    train_set = "/Users/Zealot/dev/xgboost/demo/data/agaricus.txt.train"
    # train_set = "/Users/Zealot/Documents/all_test_data_1017_2"
    # train_set = "/Users/Zealot/dev/spark-2.0.0-bin-hadoop2.4/data/mllib/sample_libsvm_data.txt"
    xgb_feature_libsvm="data/xgb_feature_libsvm"
    xgb_feature_encode(train_set, xgb_feature_libsvm)
    xgboost_lr_train(xgb_feature_libsvm,train_set)